  ...
  constructor(p, s) {
    ...
    this.meshes = [
      ...
      },
      {
        ...
        position: [-1, -1, 0],
        dimensions: [2, 2, 3],
        rotationPoint: [0, 3, 14],
        rotation: [-1.134464, 0, 0]
      },
      {
        name: 'tailMiddle',
        uv: [
