...
NodeInstance.prototype = {
  ...
  listen() {
    this._script.on('_refresh', () => {
      this.update(this._props, this._props, this._state);
    });
  },
  ...
  onupdate: function(newState) {
    if (newState !== null) {
      ...
      if (!Immutable.is(this._state, this._oldState)) {
    ...
    if (!this._rendered) {
      ...
      this.render();
    } else if (!Immutable.is(this._state, this._oldState) || !Immutable.is(this._props, this._oldProps)) {
      this.render();
    }
  },
  ...
  update: function(oldProps, newProps, oldState) {
    const args = [{
      props: oldProps.toJS(),
      state: oldState.toJS()
    }, newProps.toJS()];
  ...
  setProps: function(newProps) {
    ...
    this.update(this._oldProps, this._props, this._state);
  }
};
