...
api.worldQueryType = new GraphQLObjectType({
  name: 'WorldQuery',
  fields: () => ({
    world: {
      type: api.worldType,
...
api.worldsType = new GraphQLObjectType({
  name: 'Worlds',
  fields: () => ({
    worlds: {
      type: new GraphQLList(api.worldType),
    },
  })
});
api.deleteWorldType = new GraphQLObjectType({
  name: 'DeleteWorld',
  fields: () => ({
    worldname: {
      type: new GraphQLNonNull(GraphQLString),
